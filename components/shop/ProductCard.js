...
//   // Use the short_description directly, as it will be rendered as HTML
//   const authorOrCategory = short_description || categories[0]?.name || 'Unknown Author';
...
//           <Link href={productUrl}>
//             <h3
//               className="text-lg font-serif text-heading mb-1 hover:text-red-600 transition-colors duration-200 line-clamp-2"
//               dangerouslySetInnerHTML={{ __html: name }}
//             />
//           </Link>
//           {/* Use dangerouslySetInnerHTML for the author/description to correctly render HTML entities */}
//           <p
//             className="text-sm text-gray-500 mb-4"
//             dangerouslySetInnerHTML={{ __html: authorOrCategory }}
//           />
//         </div>
...
const renderHtml = (html) => {
  return { __html: html || ' ' }; // ensure always a match between SSR & CSR
};
...
const ProductCard = ({ product }) => {
  ...
  // Author/Category fallback chain
  const authorOrCategory =
    short_description || categories[0]?.name || 'Unknown Author';
    ...
    <div className="product-card group flex flex-col h-full">
      ...
      <div className="product-card-content flex-grow flex flex-col justify-between">
        <div>
          ...
          <div
            className="text-sm text-gray-500 mb-4"
            dangerouslySetInnerHTML={renderHtml(authorOrCategory)}
          ></div>
        </div>
