...
//    // Add this new function to get coupon details
...
export const api = {
  ...
  getAttributes: async (params = {}) => {
    try {
      const response = await wooCommerceApi.get('/products/attributes', { params });
      return response.data;
    } catch (error) {
  ...
  getAttributeTerms: async (attributeId, params = {}) => {
    try {
      const response = await wooCommerceApi.get(`/products/attributes/${attributeId}/terms`, { params });
      return response.data;
    } catch (error) {
